...
Version  : 1.1.5
Release  : 28
URL      : https://cran.r-project.org/src/contrib/stable_1.1.5.tar.gz
Source0  : https://cran.r-project.org/src/contrib/stable_1.1.5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645119741
