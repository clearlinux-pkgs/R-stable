...
export LANG=C
export SOURCE_DATE_EPOCH=1550875841
...
R CMD check --no-manual --no-examples --no-codoc -l %{buildroot}/usr/lib64/R/library stable|| : 
cp ~/.stash/* %{buildroot}/usr/lib64/R/library/*/libs/ || :
...
/usr/lib64/R/library/stable/libs/symbols.rds
